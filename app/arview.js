...
var generateArview = function() {
	...
	let create = function(dimensions, sourceCanvas) {
		...
		let reality = new Reality(sourceCanvas);
		let virtual = new Scene();
